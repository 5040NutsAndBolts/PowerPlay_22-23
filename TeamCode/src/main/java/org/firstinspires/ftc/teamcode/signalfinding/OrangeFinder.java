...
public class OrangeFinder extends OpenCvPipeline
{
    public static double orangeScore;
    ...
    public Mat processFrame(Mat input) {
        ...
        Imgproc.drawContours(selectionMask, contoursList,-1, new Scalar(30,40,40),2);
        ...
        for(MatOfPoint contour : contoursList){
            ...
            //     Drawn in blue
            Imgproc.rectangle(selectionMask, rect.tl(), rect.br(), new Scalar(15,0,255),2);
        ...
        //     Drawn in red
        Imgproc.rectangle(selectionMask, bestRect.tl(), bestRect.br(), new Scalar(30,255,0),10);
        ...
        orangeScore = bestRect.height * bestRect.width;
