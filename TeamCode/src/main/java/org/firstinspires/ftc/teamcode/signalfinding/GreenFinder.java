...
public class GreenFinder extends OpenCvPipeline
{
    ...
    public Mat processFrame(Mat input) {
        ...
        Imgproc.drawContours(selectionMask, contoursList,-1, new Scalar(75,40,40),2);
        ...
        for(MatOfPoint contour : contoursList){
            ...
            //     Drawn in blue
            Imgproc.rectangle(selectionMask, rect.tl(), rect.br(), new Scalar(40,0,255),2);
        ...
        //     Drawn in red
        Imgproc.rectangle(selectionMask, bestRect.tl(), bestRect.br(), new Scalar(40,255,0),10);
        ...
        greenScore = bestRect.height * bestRect.width;
